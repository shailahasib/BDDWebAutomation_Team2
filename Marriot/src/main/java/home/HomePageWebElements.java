...
public class HomePageWebElements  {
    ...
    public static final String siginIn = "//*[@id='QuickLinkItem4ce8']/a/span[2]";
    public static final String Sendemail = "user-id";
    public static final String password = "password";
    public static final String signIn = "#LogInFormcab6 > form > div > button";
    public static final String signInorJoin = "//*[@id='QuickLinkItemdf78']/a/span[2]";
    public static final String findHotel = "//*[@id='find-a-hotel-homePage-form']/div[2]/div[6]/button";
    public static final String destination = "CPF9MJYM_search-location";
    public static final String rates = "//*[@id='advanced-search-form']/div/div[6]/a";
    public static final String ratesNone = "//*[@id='advanced-search-form']/div/div[6]/div/div/ul/li[1]/a/fieldset/legend";
    public static final String findHotels = "//*[@id='advanced-search-form']/div/div[9]/button";
    public static final String specialoffer = "//*[@id='MainNavLink68e6']/a/p";
    public static final String findandreserv = "//*[@id='MainNavLink7e74']/a/p";
