...
//    }
    ...
    public void i_scroll_down_the_page_and_i_see_signin() throws InterruptedException {
    ...
    public void i_Enter_User_Information(DataTable dataTable) throws InterruptedException {
        ...
        homePage.enterKeywords(homePage.Marriotpassworddown, data.get(0).get(1));
    }
    @Then("I click signin")
...
//second row
    ...
    public void iEnterInSearchbox(String FirstName) throws InterruptedException {
        sleepFor(5);
        homePage.MarriotfisrstName(FirstName);
    }

    @And("I click {string} in searchbox")
    public void iClickInSearchbox(String LastName) throws InterruptedException {
        sleepFor(5);
        homePage.MarriotlastName(LastName);
    }
    @And("I enter checkInDate  {string} in searchBox")
    public void iEnterCheckInDateInSearchBox(String checkInDate) throws InterruptedException {
        sleepFor(5);
        homePage.Marriotchekindate.click();
        homePage.Marriotchekindater(checkInDate);
    }
    @And("Ican click  Signin")
    public void icanClickSignin() throws InterruptedException {

        homePage.lastSignin();
    }
    @And("I click on  Marriot Bonvoy")
    public void iClickOnMarriotBonvoy() {
        homePage.mariotBonVoy();
    }
    @And("I can click marriot credit card")
    public void iCanClickMarriotCreditCard() {
        homePage.mariotBonVoyCreditCrad();
    }
    @Then("I verify im in the rigt page")
    public void iVerifyImInTheRigtPage() {
    }

    @And("I click on  Marriot vacation")
    public void iClickOnMarriotVacation() {
        homePage.mariotVcationClick();
    }
    @And("I can click Homes $ vilas in side that")
    public void iCanClickHomes$VilasInSideThat() {
        homePage.mariotHomesAndVilas();
    }
    @And("I can click package all incliuded side that")
    public void iCanClickPackageAllIncliudedSideThat() {
        homePage.mariotMriotallpackages();
    }
    @Then("I verify im in the rigt page to the welcom massage")
    public void iVerifyImInTheRigtPageToTheWelcomMassage() {
    }
    @And("I can click marriot vacation club inside that")
    public void iCanClickMarriotVacationClubInsideThat() {
        homePage.mariotVrriotVacationClub();
    }
