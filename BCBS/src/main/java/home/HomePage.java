...
public void clicSearch() throws InterruptedException { Thread.sleep(5000);
    BcBSclicksearchbutton.click();
}
...
public void outsidedr() throws InterruptedException { Thread.sleep(5000);
    BcBSFindDoctoroutside.click();

}


public void outsidedrvalided(String exp) throws InterruptedException { Thread.sleep(5000);
...
public void getText(){
  System.out.println();BcBSgetText.getText();
...
public void BcBseditzip() throws InterruptedException {   Thread.sleep(5000);
    BcBseditzip .sendKeys(" 11427");
}
public void editzipGo() throws InterruptedException {   Thread.sleep(5000);
    BcBseditzipGo.click();
}
...
public void healthofamerica() throws InterruptedException {Thread.sleep(5000);
